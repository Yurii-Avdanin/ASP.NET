    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Code = table.Column<string>(type: "TEXT", maxLength: 101, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPromoCode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerPromoCode_Customer_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerPromoCode_PromoCodeId",
                table: "CustomerPromoCode",
                column: "PromoCodeId");
